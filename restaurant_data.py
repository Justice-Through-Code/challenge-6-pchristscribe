...
def favorite_restaurant():
    ...
    #    }
    favorite_restaurant["name"] = input("Enter the name of the restaurant: ")
    favorite_restaurant["address"] = input("Enter the address of the restaurant: ")
    favorite_restaurant["favorite_dish"] = input("What is your favorite dish at this restaurant? ")
...
def clean_print():
    ...
    #       url: https://www.yelp.com/biz/four-barrel-coffee-san-francisco`
    # etc etc
    for values in restaurant_1:
        print(f'{values}: {restaurant_1[values]}')
clean_print()